...
currently covers health, system information, the admin runtime status, data source CRUD and
management operations, and topology CRUD;
...
definitions. The web data source management and topology CRUD clients consume those definitions with
