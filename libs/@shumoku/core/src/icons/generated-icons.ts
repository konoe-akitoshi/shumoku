...
const defaultIcons: Record<string, string> = {
  ...
  'console-server': `<path d="M3 7h18v10H3V7zm2 2v6h14V9H5z"/> <circle cx="7" cy="12" r="1"/> <circle cx="10" cy="12" r="1"/> <circle cx="13" cy="12" r="1"/> <circle cx="16" cy="12" r="1"/> <circle cx="19" cy="12" r="1"/>`,
