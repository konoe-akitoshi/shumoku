...
| **Aruba Instant On** | Pull access points, switches, device metrics, and site alerts from the Instant On cloud portal |
| **Network Scan** | Actively discover topology by crawling the network over SNMP and LLDP — no inventory system required |
