...
The bundled Huawei NCE and Arista CV-CUE plugins are updated in the same PR but remain private packages; they are not included in this npm release plan.
