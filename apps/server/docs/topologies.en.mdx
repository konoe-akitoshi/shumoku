...
Use **Export** in the topology viewer to download the current sheet as SVG or a
2x PNG, or download all sheets as a standalone interactive HTML document. Server
exports use the same resolved layout and renderer as the viewer and CLI.
