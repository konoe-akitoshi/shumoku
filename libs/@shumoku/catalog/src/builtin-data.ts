        ...
        uplink: [
          {
            names: ['Gi0/9'],
            faceplate_labels: ['9'],
            interface_names: ['GigabitEthernet0/9'],
            speed: '1g',
            cage: 'rj45',
          },
          {
            names: ['Gi0/9(SFP)'],
            faceplate_labels: ['9 SFP'],
            interface_names: ['GigabitEthernet0/9'],
            speed: '1g',
            cage: 'sfp',
          },
          {
            names: ['Gi0/10'],
            faceplate_labels: ['10'],
            interface_names: ['GigabitEthernet0/10'],
            speed: '1g',
            cage: 'rj45',
          },
          {
            names: ['Gi0/10(SFP)'],
            faceplate_labels: ['10 SFP'],
            interface_names: ['GigabitEthernet0/10'],
            speed: '1g',
            cage: 'sfp',
          },
    ...
    properties: {
      ...
      ports: {
        wan: [
          ...
          {
            names: ['GE1'],
            faceplate_labels: ['GE1'],
            interface_names: ['GigaEthernet1.0'],
            speed: '1g',
            cage: 'rj45',
          },
          {
            names: ['GE1(SFP)'],
            faceplate_labels: ['GE1 SFP'],
            interface_names: ['GigaEthernet1.0'],
            speed: '1g',
            cage: 'sfp',
          },
          {
            names: ['GE2'],
            faceplate_labels: ['GE2'],
            interface_names: ['GigaEthernet2.0'],
            speed: '10g',
            cage: 'rj45',
          },
          {
            names: ['GE2(SFP+)'],
            faceplate_labels: ['GE2 SFP+'],
            interface_names: ['GigaEthernet2.0'],
            speed: '10g',
            cage: 'sfp+',
          },
          {
            names: ['GE3'],
            faceplate_labels: ['GE3'],
            interface_names: ['GigaEthernet3.0'],
            speed: '10g',
            cage: 'rj45',
          },
          {
            names: ['GE3(SFP+)'],
            faceplate_labels: ['GE3 SFP+'],
            interface_names: ['GigaEthernet3.0'],
            speed: '10g',
            cage: 'sfp+',
          },
